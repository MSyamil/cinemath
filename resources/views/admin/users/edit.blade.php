        ...
        <div class="relative bg-[#141414]/80 backdrop-blur-xl border border-white/10 rounded-2xl p-8 sm:p-10 shadow-2xl">
            ...
            <div class="flex items-center gap-3 mb-6">
                ...
                <div>
                    ...
                    <p class="text-gray-400 text-xs mt-0.5">Modify account details for <strong>{{ $user->username }}</strong></p>
                </div>
            </div>
            ...
            <form method="POST" action="{{ route('admin.users.update', $user->id) }}" class="space-y-5">
                ...
                <div>
                    ...
                    <input id="name" type="text" name="name" value="{{ old('name', $user->name) }}" placeholder="Full Name"
                ...
                <div>
                    ...
                    <input id="username" type="text" name="username" value="{{ old('username', $user->username) }}" required placeholder="username"
                           class="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#E50914]/50 focus:border-transparent transition-all">
                    @error('username')
                        <p class="mt-1.5 text-xs text-[#E50914]">{{ $message }}</p>
                    @enderror
                ...
                <div class="relative py-2">
                    ...
                    <div class="relative flex justify-center text-xs uppercase">
                        <span class="bg-[#141414] px-2 text-gray-500 font-semibold tracking-wider">Change Password</span>
                    </div>
                </div>
                <p class="text-gray-400 text-xs text-center -mt-2">Leave blank if you do not want to change the password.</p>
